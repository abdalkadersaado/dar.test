...
<html lang="en">
  <head>
    ...
    <body>
      ...
      <!-- <img src="/assets/images/qq 207.png"> -->
<div class="abcki">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                ...
                data-aos-duration="1000" style="    margin-top: -142px;">
              ...
              <div class="main-button-red">
                  <div class="scroll-to-section"><a href="aboutus.html">Get To Know us</a></div>
              </div>
          </div>
              </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="filters">
                                ...
                                <ul class="flexitab read-more-wrap">
                                 <li  class=""  style="color: white;line-height: 10px;background-color: #726d6d" ><a href="{{ route('frontend.filter_all') }}" style="color: white;line-height: 1px;">ALL</a></li>
                           ...
                           @endforeach
                                @foreach($categories as $category)
                                        <li  data-filter="*" style="color: white;line-height: 10px;background-color: #726d6d"  class="read-more-target" ><a href="{{ route('frontend.filter_category', $category->url_slug()) }}" style="color: white;line-height: 1px;" >{{ $category->name() }}</a></li>
                                @endforeach
                                </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="pagination">
                            <ul>
                                @if (request('page'))
                                    <li  style="color: white;line-height:31 px">{!! $posts_by_category_id->links() !!}</li>
                                @else
                                    <li class="active"  style="color: white;line-height: 31px" >{!! $posts_by_category_id->links() !!}</li>
                                @endif
                            </ul>
