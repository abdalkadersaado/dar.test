                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="filters">
                                <ul class="flexitab">
                                    <li  class="{{ (request()->is('blog-all-categories')) ? 'active' : '' }}"  style="color: white;line-height: 10px;background-color: #726d6d" ><a href="{{ route('blogs.all_filter') }}" style="color: white;line-height: 1px;">ALL</a></li>
                                    @foreach($categories as $category)
                                         <li  class="{{ (request()->is('blog-filter/'.$category->url_slug())) ? 'active' : '' }}"  style="color: white;line-height: 10px;background-color: #726d6d" ><a href="{{ route('blogs.filter', $category->url_slug()) }}" style="color: white;line-height: 1px;">{{ $category->name() }}</a></li>
