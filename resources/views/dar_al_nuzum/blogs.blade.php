             ...
             <div class="col-lg-12">
              <div class="filters">
                ...
                <ul class="flexitab read-more-wrap">
                  <li data-filter="*"   style="color: white;line-height: 13px;background-color: #726d6d" ><a href="{{ route('blogs.all_filter') }}" style="color: white;line-height: 1px;">ALL</a></li>
                 @foreach($global_categories as $global_category)
                        <li  data-filter="*" style="color: white;line-height: 13px;background-color: #726d6d"   ><a href="{{ route('blogs.filter', $global_category->url_slug()) }}" style="color: white;line-height: 1px;">{{ $global_category->name() }}</a></li>
                @endforeach
                @foreach($categories as $category)
                        <li  data-filter="*" style="color: white;line-height: 13px;background-color: #726d6d"  class="read-more-target" ><a href="{{ route('blogs.filter', $category->url_slug()) }}" style="color: white;line-height: 1px;" >{{ $category->name() }}</a></li>
                @endforeach
                </ul>
