...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit role ({{ $role->display_name() }})</h6>
            <div class="ml-auto">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select name="permissions[]" class="form-control select-multiple-tags" multiple="multiple">
                            ...
                            <option value="{{ $permission->id }}" {{ in_array($permission->id,old('permissions[]',$role_perms))  ? 'selected': '' }}>{{ $permission->display_name() }}</option>
                            @endforeach
                         </select>
