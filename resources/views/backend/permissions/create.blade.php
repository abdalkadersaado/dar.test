...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('BackEnd/permissions.Create_Permission') }}</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
                ...
                <div class="col-3">
                     <div class="form-group">
                        ...
                        <select name="sidebar_link" class="form-control">
                            <option value="1" {{ old('sidebar_link') == '1' ? 'selected': '' }}>Yes</option>
                            <option value="0" {{ old('sidebar_link') == '0' ? 'selected': '' }}>No</option>
                        </select>
                ...
                <div class="col-3">
                     <div class="form-group">
                        ...
                        <select name="appear" class="form-control">
                            <option value="0" {{ old('appear') == '0' ? 'selected':'' }}>No</option>
                            <option value="1" {{ old('appear') == '1' ? 'selected':'' }}>yes</option>
                        </select>
            ...
            <div class="form-group pt-4">
                <button type="submit" class="btn btn-primary">{{ __('BackEnd/permissions.save') }}</button>
            </div>
            </form>
        </div>
    </div>
