                ...
                <div class="down-content bodyk hio" >
                    ...
                    <div class="body__container kio">
                        ...
                        <div class="right__container">
                                    <form action="{{ route('frontend.login') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
                                    <fieldset id="form1">
                                        <div class="sub__title__container ">
                                            <div class="formain">
                                            <label for="" class="forml">Username</label>
                                            <input type="text" name="username" value="{{ old('username') }}"  placeholder="username" class="formi">
                                        ...
                                        <div class="input__container"> <button class="nxt__btn" onclick="nextForm();" style="padding-top: 10px"> Login</button> </div>
                                    </fieldset>
