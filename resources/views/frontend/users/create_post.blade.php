...
@section('content')
    ...
    <div class="col-lg-9 col-12">
        ...
        <div class="form-group">
            ...
            <textarea name="description" cols="30" rows="10" class="form-control summernote">{{ old('description') }}</textarea>
            @error('description')<span class="text-danger">{{ $message }}</span>@enderror
        </div>

        <div class="form-group">
            <label for="description_en">Description (English)</label>
            <textarea name="description_en" cols="30" rows="10" class="form-control summernote">{{ old('description_en') }}</textarea>
        ...
        <div class="row">
            <div class="col-4">
                <label for="category_od">Category</label>
            ...
            <div class="col-4">
                <label for="comment_able">comment_able</label>
                <select name="comment_able" class="form-control">
                    <option value="1" {{ old('comment_able') == '1' ? 'selected' : '' }}>Yes</option>
                    <option value="0" {{ old('comment_able') == '0' ? 'selected' : '' }}>No</option>
                </select>
